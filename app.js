...
const COURSES = [
  { name: "Projeto Hackathon de Ciência de Dados", year: "Mestrado", type: "Projeto", credits: 12, grade: 16 },
  { name: "Seminário em Ciência de Dados", year: "Mestrado", type: "Seminário", credits: 2, grade: 18 },
  { name: "Dissertação em Ciência de Dados em Agricultura, Alimentação, Floresta e Ambiente", year: "Mestrado", type: "Dissertação", credits: 46, grade: 17 },

  { name: "Análise e Visualização de Dados Complexos Agro-Ambientais", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 15 },
  { name: "Aprendizagem Automática Aplicada", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 16 },
  { name: "Estratégia Empresarial e Avaliação de Projectos", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 15 },
  { name: "Fundamentos da Ciência de Dados Agro-Ambientais", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 15 },
  { name: "Gestão e Armazenamento de Dados", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 15 },
  { name: "Introdução ao Python", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 16 },

  { name: "Fruticultura", year: "Mestrado", type: "Unidade Curricular", credits: 6, grade: 15 },
